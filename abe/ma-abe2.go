...
//	for i := 0; i < 100; i++ {
//		_ = new(bn256.G1).ScalarMult(a.G1, serialNumber)
//	}
...
//	startts = time.Now().UnixNano()
//	for i := 0; i < 100; i++ {
//		_ = new(bn256.G2).ScalarMult(a.G2, serialNumber)
//	}
//	endts = time.Now().UnixNano()
...
//	startts = time.Now().UnixNano()
//	for i := 0; i < 100; i++ {
//		_ = new(bn256.GT).ScalarMult(a.Gt, serialNumber)
//	}
//	endts = time.Now().UnixNano()
...
//}
//
//func (a *MAABE) Encrypt2(msg *bn256.GT, msp *MSP, pks []*MAABEPubKey) (*MAABECipher, error) {
//	// sanity checks
//	if len(msp.Mat) == 0 || len(msp.Mat[0]) == 0 {
//		return nil, fmt.Errorf("empty msp matrix")
//	}
...
//	startts := time.Now().UnixNano() / 1e3
//	// calculate ciphertext
//	c0 := new(bn256.GT).Add(msg, new(bn256.GT).ScalarMult(a.Gt, s))
//	c1 := make(map[string]*bn256.GT)
//	c2 := make(map[string]*bn256.G2)
//	c3 := make(map[string]*bn256.G2)
//	// get randomness
...
//}
//
//func (a *MAABE) Decrypt2(ct *MAABECipher, ks []*MAABEKey) (*bn256.GT, error) {
//	// sanity checks
//	if len(ks) == 0 {
